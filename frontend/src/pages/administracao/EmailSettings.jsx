...
// Config. de e-mail do Help Desk (credenciais SMTP/IMAP) — tirada de dentro
// de Configurações em 09/09/2026, agora tela própria dentro de "Administração
// do sistema". Só ADMIN chega aqui (rota protegida em App.jsx); o backend já
// bloqueava /settings/email pros demais, isso não mudou.
const EmailSettings = () => {
